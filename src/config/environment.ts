...
export const environment: Environment = {
  // API Configuration
  apiBaseUrl: 'https://api.cloudapi.knackforge.com:8000',
  env: 'development',
  ...
  cognito: {
    ...
    redirectSignIn: 'https://d3hi7rj8nb3rbs.cloudfront.net',
    redirectSignOut: 'https://d3hi7rj8nb3rbs.cloudfront.net',
